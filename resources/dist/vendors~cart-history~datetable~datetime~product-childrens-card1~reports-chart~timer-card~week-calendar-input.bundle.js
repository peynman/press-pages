(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~cart-history~datetable~datetime~product-childrens-card1~reports-chart~timer-card~week-calendar-input"],{
    ...
    function loadLocale(name) {
        ...
        if (
            ...
            try {
                ...
                __webpack_require__("./node_modules/moment/locale sync recursive [/\\\\](fa(\\.js)?)$")("./" + name);
