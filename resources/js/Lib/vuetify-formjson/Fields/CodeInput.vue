<template>
    <div style="min-height: 248px;" :class="`vf-input flex-column flex-grow-1 ${field.class ? field.class : ''}`">
        <v-label>{{ field.label }}</v-label>
        <v-card style="position: relative; width: 100%; height: 100%; min-height: 248px;" class="px-2">
